...
| Arquivo | Descrição |
|--------|-----------|
| `train-wreck.bad.php` | Exemplo de código ruim (train wreck) |
| `encapsulated.good.php` | Exemplo de código bom (encapsulado) |
| `exercise.invoice-to-refactor.php` | **Exercício:** refatore este código aplicando a Lei de Demeter |
